...
class AgentWorkflow:
    ...
    def full_pipeline(self, question: str, retriever: EnsembleRetriever, config: Dict = None):
        try:
            ...
            # Pass the config to the compiled workflow's invoke method
            # If config is None, LangGraph uses its defaults
